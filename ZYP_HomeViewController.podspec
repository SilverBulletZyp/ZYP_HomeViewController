...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  a Viewcontroller With Navigation for Project Homepage.
                   DESC

  s.homepage     = "https://github.com/SilverBulletZyp/ZYP_HomeViewController.git"
  ...
  s.social_media_url   = "https://silverbulletzyp.github.io/"
