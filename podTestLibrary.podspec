...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/SilverBulletZyp/podTestLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'SilverBulletZyp' => '807536782@qq.com' }
  s.source           = { :git => 'https://github.com/SilverBulletZyp/podTestLibrary.git', :tag => s.version.to_s }
